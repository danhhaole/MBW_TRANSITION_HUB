					...
					<nav class="flex flex-col gap-2">
						...
						<template v-for="link in view.views" :key="link.label">
							...
							<SidebarLink
								...
								:to="link.to"
								:isCollapsed="isSidebarCollapsed"
								:relatedRoutes="link.relatedRoutes || []"
								class="mx-2 my-0.5"
							/>
							...
							<div v-else class="mx-2 my-0.5 relative group overflow-visible">
								...
								<div
									@click="!isSidebarCollapsed && toggleSubmenu(link.label)"
									@mouseenter="
										isSidebarCollapsed && onEnterParent(link.label, $event)
									"
								...
								<Teleport to="body">
									<transition name="fade">
										...
										>
											<div
												class="px-3 py-2 border-b text-sm font-medium text-ink-gray-8"
											>
												{{ __(link.label) }}
											</div>
											<router-link
...
import { SignupBanner, TrialBanner, IntermediateStepModal } from 'frappe-ui/frappe'
