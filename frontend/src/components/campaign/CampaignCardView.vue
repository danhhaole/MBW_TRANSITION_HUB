      ...
      >
        ...
        <div class="border-t border-gray-100 bg-gray-50 px-4 py-3 flex justify-between items-center">
          <div class="flex items-center space-x-2">
            ...
            <button
              @click="$emit('save-as-template', campaign)"
              class="inline-flex items-center text-xs text-purple-600 hover:text-purple-800 transition-colors duration-200"
...
// Emits
defineEmits(['edit', 'view', 'delete', 'save-as-template', 'create'])
