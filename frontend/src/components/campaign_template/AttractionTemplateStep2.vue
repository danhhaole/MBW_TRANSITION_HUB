  ...
  <div class="space-y-6 animate-fadeIn">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <p class="text-sm text-gray-600">
        {{ __('Create content templates for your attraction campaign') }}
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <!-- Add Channel Dropdown (only Facebook and Zalo for templates) -->
...
const emit = defineEmits(['update:selectedChannels', 'update:facebookContent', 'update:zaloContent'])
...
// Available channels (only Facebook and Zalo for templates, no QR)
