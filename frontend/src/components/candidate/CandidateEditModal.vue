<template>
  <Dialog :model-value="props.modelValue" @update:model-value="$emit('update:modelValue', $event)" :options="{
      ...
      <div class="p-6">
        ...
        <form v-else @submit.prevent="submitForm" class="space-y-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="md:col-span-2">
                ...
                <FormControl type="text" v-model="formData.full_name" :placeholder="__('Enter full name')"
                  :error="validationErrors?.full_name" required />
              </div>
              ...
              <div>
                ...
                <FormControl type="email" v-model="formData.email" :placeholder="__('Enter email address')"
              ...
              <div>
                ...
                <FormControl type="tel" v-model="formData.phone" :placeholder="__('Enter phone number')"
              ...
              <div>
                ...
                <FormControl type="text" v-model="formData.headline"
              ...
              <div>
                ...
                <FormControl type="url" v-model="formData.avatar" :placeholder="__('Enter avatar URL')" />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <FormControl type="select" v-model="formData.source" :options="sourceOptions"
              ...
              <div>
                ...
                <FormControl type="select" v-model="formData.status" :options="statusOptions"
              ...
              <div class="md:col-span-2">
                ...
                <div class="space-y-2">
                  ...
                  <div class="flex gap-2">
                    <FormControl type="text" v-model="newSkill" :placeholder="__('Enter skill and press Enter')"
                      @keyup.enter.stop="addSkill" @keydown.enter.prevent class="flex-1" />
                    <Button type="button" variant="outline" @click="addSkill" :disabled="!newSkill.trim()" class="px-3">
          ...
          <div>
            ...
            <div class="space-y-4">
              <div>
                ...
                <FormControl type="textarea" v-model="formData.ai_summary"
                  :placeholder="__('Enter AI-generated summary')" :rows="4" />
              </div>
              ...
              <div>
                ...
                <div class="flex items-center">
                  <FormControl type="checkbox" v-model="formData.email_opt_out" class="mr-2" />
          ...
          <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
            ...
            <Button type="submit" variant="solid" :loading="saving" :disabled="!isFormValid">
...
const submitForm = async () => {
  ...
  try {
    ...
    const submitData = {
      ...formData.value,
      // skills giữ nguyên là mảng
      skills: JSON.stringify(processSkills(formData.value.skills))
    }
...
const addSkill = (event) => {
  ...
  const raw = newSkill.value?.trim() || ''
  if (!raw) return
  const incoming = processSkills(raw.includes(',') ? raw.split(',') : [raw])
  incoming.forEach(s => {
    if (!formData.value.skills.includes(s)) formData.value.skills.push(s)
  })
  newSkill.value = ''
}
