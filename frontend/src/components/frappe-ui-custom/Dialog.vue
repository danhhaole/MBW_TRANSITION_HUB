<template>
	<TransitionRoot as="template" :show="isOpen" @after-leave="$emit('after-leave')">
		<HDialog
			as="div"
			...
			>
				...
				>
					<DialogPanel
						...
						:class="{
                            'max-w-[110rem]': options.size === '10xl',
                            'max-w-[100rem]': options.size === '9xl',
                            'max-w-[90rem]': options.size === '8xl',
...
import { Button, ButtonProps, FeatherIcon } from "frappe-ui";
