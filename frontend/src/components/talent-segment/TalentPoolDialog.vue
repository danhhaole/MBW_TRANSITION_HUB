...
const talentPoolFields = [
  { label: __('Full Name'), fieldname: 'full_name', fieldtype: 'Data', value: 'full_name' },
  { label: __('Email'), fieldname: 'email', fieldtype: 'Data', value: 'email' },
  { label: __('Phone'), fieldname: 'phone', fieldtype: 'Data', value: 'phone' },
  ...
  { label: __('Source'), fieldname: 'source', fieldtype: 'Data', value: 'source' },
  { label: __('Status'), fieldname: 'status', fieldtype: 'Select', options: 'Active\nInactive\nBlacklisted', value: 'status' },
  { label: __('Gender'), fieldname: 'gender', fieldtype: 'Select', options: 'Male\nFemale\nOther', value: 'gender' },
  { label: __('Experience Years'), fieldname: 'experience_years', fieldtype: 'Int', value: 'experience_years' },
  { label: __('Education Level'), fieldname: 'education_level', fieldtype: 'Select', options: 'High School\nBachelor\nMaster\nPhD', value: 'education_level' },
  { label: __('Position'), fieldname: 'position', fieldtype: 'Data', value: 'position' },
  { label: __('Expected Salary'), fieldname: 'expected_salary', fieldtype: 'Currency', value: 'expected_salary' },
  { label: __('Rating'), fieldname: 'rating', fieldtype: 'Rating', value: 'rating' },
  { label: __('City'), fieldname: 'city', fieldtype: 'Data', value: 'city' },
  { label: __('Last Interaction Date'), fieldname: 'last_interaction_date', fieldtype: 'Date', value: 'last_interaction_date' },
