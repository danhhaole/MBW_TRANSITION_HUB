    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <div class="flex-1 overflow-auto">
        <div class="max-w-full mx-4 px-4 py-8">
          <!-- Page Header -->
          <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900">{{ __('Flow Template Library') }}</h1>
            <p class="text-sm text-gray-500 mt-1">
              {{ __('Browse and use pre-built flow templates to automate your workflows') }}
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg shadow mb-6">
            ...
            <div class="p-6">
              ...
              <!-- Empty State -->
              <div v-else-if="!loading && displayedTemplates.length === 0" class="text-center py-12">
                <FeatherIcon name="inbox" class="w-16 h-16 mx-auto mb-4 text-gray-400" />
              ...
              <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                <div
                  ...
                  class="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow cursor-pointer group"
                >
                  <!-- Template Thumbnail -->
                  ...
                  <div class="p-4">
                    <div class="flex items-start justify-between mb-2">
                      <h3 class="text-sm font-semibold text-gray-900 line-clamp-2 flex-1 group-hover:text-blue-600 transition-colors">
                    ...
                    <div class="flex items-center justify-between">
                      <div class="flex items-center space-x-2">
                        ...
                        <div v-if="template.channel" class="flex items-center text-xs text-gray-500">
                          <FeatherIcon :name="getChannelIcon(template.channel)" class="w-3 h-3 mr-1" />
                          {{ template.channel }}
                        </div>
                      </div>
              ...
              <!-- Pagination -->
              <div v-if="pagination.total > 0" class="mt-8 pt-6 border-t border-gray-200">
                <div class="flex items-center justify-between">
