			...
			<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
				<div class="flex justify-between items-start">
					...
					<div class="flex items-center space-x-3">
						<Button variant="outline" theme="gray" @click="editTalentSegment">
							<template #prefix>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="h-4 w-4"
						...
						<Button variant="outline" theme="red" @click="deleteTalentSegment">
							<template #prefix>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="h-4 w-4"
					...
					<div class="space-y-4">
						<div>
							...
							<p class="mt-1 text-sm text-gray-900">
								{{ talentSegment.title || 'N/A' }}
							</p>
						</div>
						<div>
							<span class="text-sm font-medium text-gray-500">Description:</span>
							<p class="mt-1 text-sm text-gray-900">
								{{ talentSegment.description || 'N/A' }}
							</p>
						</div>
						<div>
				...
				<div v-if="talentSegment.criteria" class="mt-6">
					...
					<div class="mt-2 bg-gray-50 rounded-lg border border-gray-200 p-4">
						<pre class="text-sm text-gray-900 whitespace-pre-wrap">{{
							formatCriteria(talentSegment.criteria)
						}}</pre>
					</div>
				</div>
			</div>
				...
				<div class="p-6">
												...
												<div class="flex-shrink-0 h-8 w-8">
													...
													>
														<span
															...
															>{{
																candidate.candidate_name?.charAt(
																	0,
																) || '?'
															}}</span
														>
					...
					<div v-else-if="activeTab === 'analytics'">
						...
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
							<div
								class="bg-white p-6 rounded-lg border border-gray-200 text-center"
							>
