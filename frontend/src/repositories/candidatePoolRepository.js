...
export const getCandidatePools = (params = {}) => {
  ...
  return call('mbw_mira.mbw_mira.candidatepool.candidatepool.get_candidate_pools_paginated', {
    page,
    limit,
    search,
    status,
...
export const getCandidatePoolStats = () => {
  return call('mbw_mira.mbw_mira.candidatepool.candidatepool.get_candidate_pool_stats')
}

// Search candidate pools
export const searchCandidatePools = (query = "", limit = 10) => {
  return call('mbw_mira.mbw_mira.candidatepool.candidatepool.search_candidate_pools', {
    query,
    limit
  })
}
...
export const getCandidatePoolByName = (name) => {
  return call('mbw_mira.mbw_mira.candidatepool.candidatepool.get_candidate_pool_by_name', {
    name
  })
}
...
export const getCandidatePoolFilterOptions = () => {
  return call('mbw_mira.mbw_mira.candidatepool.candidatepool.get_candidate_pool_filter_options')
}
