...
export const candidateCampaignRepository = new UniversalRepository('Mira Talent Campaign')
...
export const candidateRepository = new UniversalRepository('Mira Contact')
