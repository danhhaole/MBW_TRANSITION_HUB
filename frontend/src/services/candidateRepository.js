...
export const getCandidatesResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.get_prospects_paginated',
  method: 'GET',
  transform: (data) => {
    if (data?.success) {
      return {
...
export const getCandidateStatsResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.mira_prospect.get_talent_profile_stats',
  method: 'GET',
...
export const searchCandidatesResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.mira_prospect.search_talent_profiles',
  method: 'GET',
...
export const getCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.mira_prospect.get_talent_profile_by_name',
  method: 'GET',
...
export const createCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.mira_prospect.create_talent_profile',
  method: 'POST',
  transform: (data) => data?.talent_profile || null
})
...
export const updateCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.mira_prospect.update_talent_profile',
  method: 'POST',
  transform: (data) => data?.talent_profile || null
})
...
export const deleteCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.mira_prospect.delete_talent_profile',
  method: 'DELETE',
...
export const getFilterOptionsResource = createResource({
  url: 'mbw_mira.mbw_mira.mira_prospect.mira_prospect.get_talent_profile_filter_options',
  method: 'GET',
