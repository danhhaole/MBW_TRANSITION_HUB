...
export const getCandidatesResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.get_prospects_paginated',
  method: 'GET',
  transform: (data) => {
    if (data?.success) {
      return {
...
export const getCandidateStatsResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.get_talent_profile_stats',
  method: 'GET',
...
export const searchCandidatesResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.search_talent_profiles',
  method: 'GET',
...
export const getCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.get_talent_profile_by_name',
  method: 'GET',
...
export const createCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.create_talent_profile',
  method: 'POST',
  transform: (data) => data?.talent_profile || null
})
...
export const updateCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.update_talent_profile',
  method: 'POST',
  transform: (data) => data?.talent_profile || null
})
...
export const deleteCandidateResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.delete_talent_profile',
  method: 'DELETE',
...
export const getFilterOptionsResource = createResource({
  url: 'mbw_mira.mbw_mira.doctype.mira_contact.mira_contact.get_talent_profile_filter_options',
  method: 'GET',
