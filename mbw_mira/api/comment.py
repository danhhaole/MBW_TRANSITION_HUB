    ...
    for mention in mentions:
        ...
        try:
            ...
            if reference_doctype == "Mira Campaign":
                ...
                email_url = f"/mbw_mira/campaign/{reference_name}#comments"
            else:
                notification_url = f"/{reference_doctype.lower().replace('_', '-')}/{reference_name}#comments"
                email_url = f"/mbw_mira/{reference_doctype.lower().replace('_', '-')}/{reference_name}#comments"
...
def add_comment(reference_doctype, reference_name, content, comment_email, comment_by):
    ...
    try:
        ...
        frappe.enqueue(
            "mbw_mira.api.comment.notify_mentioned_users",
            queue="short",
