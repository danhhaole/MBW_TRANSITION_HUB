...
class MiraNotification(Document):
	def on_update(self):
		if self.to_user:
			frappe.publish_realtime("mira_notification", user= self.to_user)
...
def notify_user(args):
	...
	if frappe.db.exists("Mira Notification", values):
		return
